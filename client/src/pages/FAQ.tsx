...
const additionalFaqs = [
  ...
  { q: "Do you offer funding for startups?", a: "Yes, though options are more limited for businesses under 6 months old. Revenue-based funding typically requires 4+ months of bank statements. For newer businesses, we recommend our unsecured business capital program (requires solid personal credit) or our business credit building program." },
